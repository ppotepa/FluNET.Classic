...
public interface ILanguageModule
{
    ...
    IReadOnlyCollection<PredicateDescriptor> Predicates { get; }
    IReadOnlyCollection<OperatorDescriptor> Operators { get; }
    IReadOnlyCollection<IntrinsicDescriptor> Intrinsics { get; }
}
