...
public sealed class S3StorageProvider : IStorageProvider
{
    ...
    public S3StorageProvider(IS3ObjectClient client, string bucket) { _client = client; _bucket = bucket; }
...
public sealed class S3StorageModule : LanguageModule { public override string Name => "storage.s3"; public override IReadOnlyCollection<string> Dependencies => new[] { "storage" }; }
