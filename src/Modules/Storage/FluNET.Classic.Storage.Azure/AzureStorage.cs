...
public sealed class AzureBlobStorageProvider : IStorageProvider
{
    ...
    public AzureBlobStorageProvider(IAzureBlobClient client, string container)
    {
        _client = client;
...
public sealed class AzureBlobStorageModule : LanguageModule
{
    public override string Name => "storage.azure"; public override IReadOnlyCollection<string> Dependencies => new[] { "storage" };
}
