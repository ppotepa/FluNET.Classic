...
public sealed class PostgreSqlModule : LanguageModule { public override string Name => "sql.postgresql"; public override IReadOnlyCollection<string> Dependencies => new[] { "sql" }; }
