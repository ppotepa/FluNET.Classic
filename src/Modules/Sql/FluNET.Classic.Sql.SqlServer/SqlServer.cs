...
public sealed class SqlServerModule : LanguageModule
{
    public override string Name => "sql.sqlserver"; public override IReadOnlyCollection<string> Dependencies => new[] { "sql" };
}
