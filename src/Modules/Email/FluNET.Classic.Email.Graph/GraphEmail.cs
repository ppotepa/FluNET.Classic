...
public interface IGraphMailClientAdapter
{
...
public sealed class GraphEmailModule : LanguageModule
{
    public override string Name => "email.graph"; public override IReadOnlyCollection<string> Dependencies => new[] { "email" };
}
