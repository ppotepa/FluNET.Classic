...
public sealed class SendGridEmailModule : LanguageModule
{
    public override string Name => "email.sendgrid"; public override IReadOnlyCollection<string> Dependencies => new[] { "email" };
}
