...
{
    public ValueTask SendAsync(string to, string message, CancellationToken cancellationToken = default) => throw new InvalidOperationException("No IEmailSender is registered. Configure one in the host before using SEND.");
}
