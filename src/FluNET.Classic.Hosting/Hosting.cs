...
public static class FluNetHost { public static ServiceProvider Create(FluNetOptions? options = null, Action<IServiceCollection>? configure = null) { var services = new ServiceCollection(); services.AddFluNetClassic(options); configure?.Invoke(services); return services.BuildServiceProvider(); } }
