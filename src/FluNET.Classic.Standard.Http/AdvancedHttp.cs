...
public enum HttpConditionKind { IF_MATCH, IF_NONE_MATCH }
...
[Verb("CREATE"), Qualifier("REQUEST"), ExecutionTrait(ExecutionTrait.Pure)]
public sealed class CreateHttpRequest : IVerb<HttpRequest>, ICreate, IFrom<HttpEndpoint>, IUsing<HttpMethodKind>, IWith<HttpBody>, IPipelineProducer<HttpRequest>
{
    ...
    public CreateHttpRequest([From] HttpEndpoint endpoint, [Using] HttpMethodKind method, [With] HttpBody? body = null) { _endpoint = endpoint; _method = method; _body = body; }
...
[Verb("TRANSFORM"), Qualifier("REQUEST"), ExecutionTrait(ExecutionTrait.Pure)]
public sealed class AddHttpHeader : IVerb<HttpRequest>, ITransform, IWhat<HttpRequest>, IWith<HttpHeader>, IPipelineConsumer<HttpRequest>, IPipelineProducer<HttpRequest>
{
    ...
    public AddHttpHeader([What] HttpRequest request, [With] HttpHeader header) { _request = request; _header = header; }
    public ValueTask<HttpRequest> ExecuteAsync(VerbExecutionContext context, CancellationToken cancellationToken = default)
    {
        ...
        return ValueTask.FromResult(_request with { Headers = new HttpHeaders(values) });
    }
}
...
public sealed class AddHttpCondition : IVerb<HttpRequest>, ITransform, IWhat<HttpRequest>, IWith<HttpCondition>, IPipelineConsumer<HttpRequest>, IPipelineProducer<HttpRequest>
{
    ...
    public AddHttpCondition([What] HttpRequest request, [With] HttpCondition condition) { _request = request; _condition = condition; }
...
[Verb("GET"), Qualifier("ETAG"), ExecutionTrait(ExecutionTrait.Pure)]
